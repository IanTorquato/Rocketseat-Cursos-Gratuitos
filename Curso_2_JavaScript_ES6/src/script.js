...
const teste = () => ({ nome: 'Ian', idade: '18' })
console.log(teste())

// Aula_09 -Desestruturação

const usuario = { name: 'Ian', age: '18', address: { city: 'Gravatal', state: 'SC' } }

// Para buscar mais de uma informação do usuário, basta colocar "{}" antes do "=", e depois o objeto 'alvo'
const { name, age, address: { city } } = usuario
...
const usuario2 = { name: 'Ian', age: 18, city: 'Gravatal' }

const { name2, ...qualquerNome } = usuario2
console.log(name2)
...
const usuario3 = { ...usuario2, age: 19 }
...
const usuario4 = { name3, age3, city: 'Gravatal' }
...
const users = [
  { name: 'Ian', age: 18, city: 'Gravatal' },
  { name: 'Ana', age: 17, city: 'Gravatal' },
  { name: 'Davi', age: 17, city: 'Gravatau' }
]
...
const usuario5 = { name5: 'Ian5', age5: 18 }
...
const { name6, address: { city6 }, address: { state } } = empresa
...
// Em parâmetros
const mostraInfo = ({ name, age }) => `${name} tem ${age} anos.`

const usu2 = { name: 'Ian', age: 18 }
...
const usuario7 = {
  name7: 'Ian7',
  age: 18,
  address: { city: 'Gravatal', state: 'SC', country: 'Brasil' }
}

const usuario8 = { ...usuario7, name8: 'Daniel8' }
console.log(usuario8)

const usuario9 = {
  ...usuario7,
  address: { ...usuario7.address, city: 'Florianópolis' }
}
